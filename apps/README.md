...
| [`typescript/fraud-ops-caller`](typescript/fraud-ops-caller/) | TypeScript / Next.js | Pack-fired fraud-ops desk: KYC, evidence, collections, and merchant intents with a stub dial by default, masked plan destinations, and live CALL-E gated by operator secret, pinned origin, and confirm phrase. [Demo video](https://www.youtube.com/watch?v=FHa4QgJPgj4) |
